...
- [x] The Prize Ladder is pinned to the top of the viewport on small screens and never scrolls away
- [x] The ladder remains readable when compacted to two columns
- [x] The Case grid scrolls beneath the pinned ladder
- [x] Case tap targets are comfortable for a thumb and mis-taps are not a constant risk
- [x] The Player's Case remains clearly distinct and visible on a small screen
- [x] The Offer panel and Offer History table fit without horizontal scrolling
- [x] The Swap Decision and game over screens work on a phone
- [x] The game is playable start to finish at a 375px viewport width
- [x] Nothing about the desktop flanking-column layout regresses
