...
- [x] Every Offer is recorded in state as it is made
- [x] The table shows Round, Offer amount, and change from the previous Offer
- [x] Rises and falls are distinguished by direction indicator and colour
- [x] The best Offer refused so far is shown, with the Round it came from
- [x] The current Round's row is visually highlighted
- [x] The table is visible only while the player is deciding on an Offer
- [x] No Expected Value, odds, or derived statistic appears anywhere in the table
- [x] Amounts use the same ₱ formatting as the rest of the game
- [x] Tests: the recorded history matches the Offers actually made across a full game
